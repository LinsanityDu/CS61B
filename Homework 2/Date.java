...
public class Date {
	  ...
	  public Date(String s) { 
		  ...
		  if (s.matches(".*[/].*[/].*")==false) {
			 ...
			 // System.exit(0);
			  ...
			  if (isValidDate(iday,imonth,iyear)== true) {
				  this.day=iday;
				  this.month=imonth;
				  this.year=iyear;
			  } else {
	  ...
	  public static boolean isValidDate(int month, int day, int year) {
		  ...
		  if (year<1){
			  ...
			  actualDay = daysInMonth (month, year);
			  if (actualDay >= day) {
				  return true;
			  } else {
				  return false;
	  ...
	  public int dayInYear() {
		  ...
		  if (this.month==1) {
			  ...
			  while (i<this.month) {
				  totalDay+=daysInMonth(i, this.year);
				  i++;
			  }
			  totalDay+=this.day;
		  }
	  ...
	  public int difference(Date d) {
		  ...
		  if (this.isBefore(d)== true) {
			  beforeYear=this.year;
			  afterYear=d.year;
			  while (beforeYear<afterYear) {
				  if (isLeapYear(beforeYear)== true) {
					  dateDif=dateDif+366;
				  } else {
					  dateDif=dateDif+365;
				  }
			  ...
			  dateDif+=d.dayInYear()-this.dayInYear();
			  dateDif=-dateDif;
			  ...
			  dateDif+=this.dayInYear()-d.dayInYear();
		  } else {
			  dateDif=0;
		  }
		  return dateDif;                  
